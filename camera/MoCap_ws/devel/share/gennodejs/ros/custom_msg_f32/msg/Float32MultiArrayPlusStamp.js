...
class Float32MultiArrayPlusStamp {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Float32MultiArrayPlusStamp(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Float32MultiArrayPlusStamp(null);
...
module.exports = Float32MultiArrayPlusStamp;
